      ...
      {commentaires.length > 0 && (
        <>
          <h2 className="s-titre">
            ...
            <span className="s-sous">rédigée par un modèle ; celles qu'aucun humain n'a relues sont signalées comme telles</span>
          </h2>
                ...
                <div className="carte commentaire" key={c.commentary_id}>
                  <div className="com-tete">
                    ...
                    <span className="com-date">
                      collecte n° {c.run_id ?? "—"} ·{" "}
                      {relu(c)
                        ? "validée le " + dateCH(c.validated_at)
                        : "rédigée le " + dateCH(c.created_at)}
                    </span>
                  </div>
          ...
          {commentaires.length > 2 && (
            <p className="note" style={{ marginTop: 8 }}>
              {commentaires.length - 2} autres lectures, une par marché, sur les pages de marché.
            </p>
          )}
        </>
      )}
